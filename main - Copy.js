...
//
    ...
    function updateStartList() {
        ...
        for (let key in players) {
            ...
            tr.children("td:nth-child(1)").html(player.player_id);
            tr.children("td:nth-child(2)").html(tickToTime(player.start_time));
        }
    ...
    function updateCurrentList() {
        ...
        for (let key in players) {
            ...
            if (player.is_finish == '1' || player.is_finish == 1)
                continue;
            ...
            tr.children("td:nth-child(1)").html(player.player_id);
            //tr.children("td:nth-child(2)").html(tickToTime(player.elapsed_time));
    ...
    function updateFinishList() {
        ...
        for (let key in players) {
            ...
            if (player.is_finish == '0' || player.is_finish == 0 || player.is_finish == undefined)
                continue;
            ...
            tr.children("td:nth-child(1)").html(player.finish_num);
            tr.children("td:nth-child(2)").html(player.player_id);
            tr.children("td:nth-child(3)").html(tickToTime(player.start_time));
            tr.children("td:nth-child(4)").html(tickToTime(player.elapsed_time));
        }
